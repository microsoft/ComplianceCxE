 ...
 */
 ...
 function CookieConsent(props) {
    ...
    function writeCookieStatus() {
        if (document.getElementById("status")){
            if (cookieConsent.trackingAllowed()){
                document.getElementById("status").innerHTML = "All Cookies"
                document.getElementById("status").style.color = "green"
            } else {
                document.getElementById("status").innerHTML = "Necessary Cookies Only"
    ...
    this.reset = function () {
        ...
        var clarifyCookie1 = "_clck"
        var clarifyCookie2 = "_clsk"
        removeCookie(clarifyCookie1)
        removeCookie(clarifyCookie2)
