...
Combined with data loss prevention you can help prevent the accidental oversharing of the sensitive information in your organization. With this in mind, let’s get started with understanding the capabilities which are available as part of [Microsoft Information Protection (MIP)](#mip-intro), how you discover sensitive information and protect it using the various provided tools provided by MIP and [Data Loss Prevention (DLP)](#dlp-intro)

## Topics in this DAG:
* [Your Deployment Plan](#your-deployment-plan)

### Microsoft Information Protection
* [Microsoft Information Protection](#mip-intro)
* [Best Practices](#mip-bp)
     - [Prior to Deployment Plan](#mip-prior-to-deployment-plan)
     - [Deployment Test Plan](#mip-deployment-test-plan)
     - [Production Deployment](#mip-production-deployment)
* [Considerations](#mip-considerations)
    - [MIP Client Considerations](#mip-client-considerations)
* [Helpful Resources](#mip-hr)

### Data Loss Prevention
* [Data Loss Prevention](#dlp-intro)
* [Best Practices](#dlp-bp)
     - [Prior to Deployment Plan](#dlp-prior-to-deployment-plan)
     - [Deployment Test Plan](#dlp-deployment-test-plan)
     - [Production Deployment](#dlp-production-deployment)
* [Considerations](#dlp-considerations)
* [Helpful Resources](#dlp-hr)

### Appendix
* [Appendix - Additional Resources](#mip-dlp-appendix)
* [License Requirements](#license-requirements)
    - [Microsoft Information Protection](#mip-license-reqs)
    - [Data Loss Prevention](#dlp-license-reqs)
...
* [Microsoft Information Protection (MIP)](#mip-intro)

* [Data Loss Prevention (DLP)](#dlp-intro)
