...
In today’s climate one of the top concerns for security and compliance are the data leakage from insider risks. Studies point to insider risk from specific user events and activities; protecting your organization may seem impossible if one does not have insight or a way to identify the risk but worse if you cannot mitigate the risk you do not know about. With this in mind, let’s get started with Microsoft 365 [Insider Risk Management (IRM)](#ir-intro) and [Communications Compliance (CC)](#cc-intro) solutions.

## Topics in this DAG:
* [Your Deployment Plan](#your-deployment-plan)

### Communication Compliance
* [Communication Compliance](#cc-intro)
* [Best Practices](#cc-bp)
    - [Policy Definition](#policy-definition)
    - [Investigating Alerts](#investigating-alerts)
* [Considerations](#cc-considerations)
* [Helpful Resources](#cc-hr)

### Insider Risk Management
* [Insider Risk Management](#ir-intro)
* [Best Practices](#ir-bp)
    - [Prior to Deployment Plan](#prior-to-deployment-plan)
    - [Deployment Test Plan](#deployment-test-plan)
    - [Production Deployment](#production-deployment)
* [Considerations](#ir-considerations)
* [Helpful Resources](#ir-hr)

### Appendix
* [Appendix - Additional Resources](#ir-cc-appendix)
* [License Requirements](#license-requirements)
    - [Communication Compliance](#cc-license-reqs)
    - [Insider Risk Management](ir-license-reqs)
...
### Communication Compliance (CC) {#cc-license-reqs}
...
### Insider Risk Management (IRM) {#ir-license-reqs}
